...
export const APP_ERROR_DEFINITIONS = {
  ...
  TRANSCRIPTION_INSTALLATION_INCOMPLETE: { stage: 'speech-recognition', cause: 'component-unavailable', retryable: false },
  TRANSCRIPTION_SYSTEM_SUPPORT_MISSING: { stage: 'speech-recognition', cause: 'component-unavailable', retryable: false },
  TRANSCRIPTION_COMPONENT_QUARANTINED: { stage: 'speech-recognition', cause: 'component-unavailable', retryable: false },
