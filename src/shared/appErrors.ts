...
export const APP_ERROR_DEFINITIONS = {
  ...
  SUBTITLE_ALIGNMENT_FAILED: { stage: 'voice', cause: 'processing-failed', retryable: true },
  SUBTITLE_ALIGNMENT_RESULT_INVALID: { stage: 'voice', cause: 'invalid-media', retryable: true },
